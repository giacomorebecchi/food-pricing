...
def join(
    ...
    ddf = read_categorical_parquet(data_info[0], categoricals)
    for i in range(1, len(data_info)):
        temp_ddf = read_categorical_parquet(data_info[i], categoricals)
...
if __name__ == "__main__":
    join(DATA_INFO, JOIN_ON, CATEGORICALS, OUTPUT_PATH)
